...
## [1] AI-driven framework for perturbation response prediction in brain organoids

### 1-1. Pre-training a foundation model
...
### 1-2. Fine-tuning with perturbation data
...
### 1-3. Evaluating predictive performances
...
### 1-4. Predicting perturbation responses
